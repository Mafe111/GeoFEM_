...
CREATE TABLE `capa_suelo` (
  ...
  `profundidad_inicio` float DEFAULT NULL,
  `profundidad_fin` float DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `configuracion_analisis` VALUES (1,1,'SSR',0.001,500,0,0);
...
CREATE TABLE `material` (
  ...
  `angulo_dilatancia` float NOT NULL DEFAULT '0',
...
INSERT INTO `material` VALUES (1,1,'Arcilla Competente','MOHR_COULOMB',19.5,30000,0.3,25,28,0,1,'#2ECC71');
...
-- Dump completed on 2026-05-28  5:56:47
